...
df_kmeans=user1[['TowerLon','TowerLat']]
...
ax.set_xlabel('TowerLon')
ax.set_ylabel('TowerLat')
ax.scatter(df_kmeans.TowerLon,df_kmeans.TowerLat, c='g', marker='o', alpha=0.2)
...
ax.set_xlabel('TowerLon')
ax.set_ylabel('TowerLat')
ax.scatter(df_kmeans.TowerLon, df_kmeans.TowerLat, marker='.', alpha=0.3)
centroids = kmeans.cluster_centers_
ax.scatter(centroids[:,0], centroids[:,1], marker='x', c='red', alpha=0.5, linewidths=3, s=169)